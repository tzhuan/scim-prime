...
#define SCIM_PRIME_CONFIG_LEARN_WORD_KEY                      "/IMEngine/PRIME/LeanWord"

#define SCIM_PRIME_CONFIG_COMMIT_KEY_DEFAULT                  "Return,KP_Enter"
#define SCIM_PRIME_CONFIG_CONVERT_KEY_DEFAULT                 "space"
...
#define SCIM_PRIME_CONFIG_CONV_PREV_CANDIDATE_KEY_DEFAULT     "Up,KP_Subtract,Control+p,Control+P"
